...
A series of notebooks that explore the theory fundamentals of Deep Learning and examples in Python using Keras and TensorFlow 2.
## Deep Learning
...
## Computer Vision
- [Introduction to Convolutional Neural Networks](https://github.com/victorviro/Deep_learning_python/blob/master/Introduction_to_CNNs.ipynb)
